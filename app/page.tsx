...
export function User(props: UserType) {
  return (
    <div className="flex text-center align-middle font-bold bg-neutral-900 rounded-2xl py-3 px-3 mb-2">
      <div className="bg-blue-700 w-min-30 py-2 px-3 mx-3 rounded-2xl hover:bg-blue-900 cursor-pointer transition duration-300 w-1/2">
        {props.userId}
      </div>
      <div className="bg-blue-700 w-min-30 py-2 px-3 mx-3 rounded-2xl hover:bg-blue-900 cursor-pointer transition duration-300 w-1/3">
        {props.score}
      </div>
      <div className="bg-blue-700 w-min-30 py-2 px-3 mx-3 rounded-2xl hover:bg-blue-900 cursor-pointer transition duration-300 w-1/6">
        ≡
      </div>
    </div>
  );
